...
import { CreateNFTCollectionRequest, CreateNFTCollectionResponse, GetNFTBalanceRequest, GetTokenURIRequest, SetTokenURIRequest } from "../types/resources/nftClient.js";
export declare class NftClient {
     ...
     */
    getNFTBalance({ spgNftContract, owner }: GetNFTBalanceRequest): Promise<bigint>;
}
