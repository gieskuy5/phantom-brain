...
export class CbMpcWasm {
    ...
    tdh2Combine(names, pubShares, partials, globalPubKey, ciphertext, label, threshold) {
        const M = this.M;
    ...
    tdh2ExtractLabel(ciphertext) {
        ...
        try {
            ...
            if (rv !== 0)
                throw new Error(`wasm_tdh2_extract_label failed: ${rv}`);
            return this.readResult(outPtrPtr, outSizePtr);
        }
        finally {
            M._free(ctPtr);
